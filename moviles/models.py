...
class Viajes(models.Model):
    ...
    movil = models.ForeignKey(Movil, on_delete=models.CASCADE, verbose_name='Movil')
    cliente = models.ForeignKey(Cliente, on_delete=models.CASCADE, default=None, null=True, verbose_name='Empresa')
    area = models.ForeignKey(Area, on_delete=models.CASCADE, default=None, null=True, verbose_name='Área')
    fecha = models.DateField()
    origen = models.ForeignKey(Predios, on_delete=models.CASCADE, related_name='origen_predio', blank=True, null=True)
    destino = models.CharField(max_length=100, choices=DESTINOS_CHOICES, blank=True, null=True)
    producto = models.CharField(max_length=100, choices=PRODUCTO_CHOICES, default='Pulpable', blank=True, null=True)
    tn_pulpable = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='KG Pulpable')
    tn_aserrable = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='KG Aserrable')
    tn_chip = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='KG Chips')
    sin_actividad = models.BooleanField(default=False, verbose_name='Sin Actividad')
    motivo_sin_actividad = models.CharField(max_length=255, blank=True, null=True, verbose_name='Motivo Sin Actividad')
    observaciones = models.TextField(blank=True, null=True)
    personal = models.ForeignKey(Personal, on_delete=models.CASCADE, blank=True, null=True, verbose_name='Chofer')
